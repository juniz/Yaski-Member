                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:24px;font-weight:300;line-height:30px;text-align:left;color:#000000;">Terima kasih telah mendaftar workshop.</div>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:300;line-height:20px;text-align:left;color:#000000;">Pendaftaran Anda berhasil dilakukan dan pembayaran Anda telah diproses. Ini ringkasan data Anda:</div>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:300;line-height:20px;text-align:left;color:#000000;">ID Pesanan : <b>{{ $order_id ?? '-' }}</b></div>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:300;line-height:20px;text-align:left;color:#000000;">Workshop : <b>{{ $workshop ?? '-' }}</b></div>
                                </td>
                              </tr>
                            </tbody></table>
                          </div>
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Roboto, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                                    <tbody>
                                        ...
                                        <td width="60%" style="font-size: 14px; line-height: 16px; word-break: normal;">
                                            <p style="margin: 0 0 5px 0;"> {{ $item->pesanan ?? '-' }} </p>
                                            <p style="margin: 0 0 5px 0; color: #ACA9BB; padding-bottom: 10px;"> {{ $item->nama ?? '-' }} </p>
                                        </td>
                                        <td align="right" style="font-size: 14px; line-height: 16px; word-break: normal; padding-top: 20px; padding-right: 5px;">
                                            <p style="margin: 0 0 5px 0;">x{{ $item->jml ?? '0' }}</p>
                                        </td>
                                        <td align="right" style="font-size: 14px; line-height: 16px; word-break: normal; padding-top: 20px;">
                                            <p style="margin: 0 0 5px 0;">Rp. {{ $item->harga ?? '0.00' }}</p>
                                        </td>
                                        </tr>
                                    <tr>
