...
<div class="row">
    <div class="col-xl-12">
        ...
        @else
        <div class="bg-image" style="
            background-image: url('{{URL::asset("assets/images/profile-bg-1.jpg")}}'); height:
            50vh;background-position: center; background-size: cover; background-repeat: no-repeat; margin: -24px -24px
            23px -24px; padding: 140px 0px; position: relative; "></div>
	@endif
    </div>
</div>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target=".update-profile" href="#">Profile</a></li>
                                        <li><a class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target=".update-fasyankes" href="#">Fasyankes</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row mb-3">
                                    <h6>Download template pakelaring</h6>
                                    <a href="{{ URL::asset('assets/files/template_paklaring.xlsx') }}"
                                        class="btn btn-sm btn-primary ms-2"><i class="bx bx-download"></i> Download</a>
                                </div>
                                @if(empty($paklaring))
                                <h6 class="text-center">Data Kosong</h6>
                                @else
                                <iframe src="{{ asset('storage/pakelaring/'. $paklaring->file) }}" frameborder="0"
            ...
            <div class="modal-dialog modal-dialog-centered">
                ...
                @enderror" id='nama' name="nama">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('jenis') is-invalid @enderror" data-trigger
                                    name="jenis" id="jenis" placeholder="Jenis Fasyankes">
            ...
            @enderror" id='direktur' name="direktur">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control @error('alamat') is-invalid @enderror"
                                    id='alamat' name="alamat" cols="3">{{$fasyankes->alamat ?? ''}}
            </textarea>
                        ...
                        <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="update-paklaring">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                    id="tanggal" value="{{ $paklaring->tgl_pakai ?? '' }}" name="tanggal"
                                    placeholder="Enter tanggal" autofocus>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="text-danger" role="alert" id="dokumenError" data-ajax-feedback="dokumen">
                                </div>
                            </div>
