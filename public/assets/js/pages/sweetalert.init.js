...
document.getElementById("sa-close").addEventListener("click", function () {
  ...
  Swal.fire({
    ...
    if (result.dismiss === Swal.DismissReason.timer) {
      ...
      /* eslint-disable */
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("298fa8e8_0", 'I was closed by the timer')));
    }
  });
}); //custom html alert
