...
document.getElementById("sa-close").addEventListener("click", function () {
  ...
  Swal.fire({
    ...
    if (result.dismiss === Swal.DismissReason.timer) {
      var _console;
      /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("3089521571_0", 'I was closed by the timer')));
    }
  });
});
